...
public class ToolGenerator {
   ...
   *
   * @param mapID the mapID int of the map that is being opened with the key. will be the toolID of
   * the item.
   * @return the key item.
   */
   ...
   *
   * @param crateID int id of the crate that is being opened with the key. will be the toolID of the
   * item.
   * @return the key item.
   */
