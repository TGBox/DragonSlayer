...
public class ConsumableCreator {
  ...
  private static final String[] PREFIX_NAMES = new String[]{"cursed", "half empty", "dark-purple",
      "partially empty",
  ...
  private static final String[] HEALING_VALUE_ADJECTIVES = new String[]{"tiny", "small", "light",
      "regular-sized",
      "big", "large", "huge"};
