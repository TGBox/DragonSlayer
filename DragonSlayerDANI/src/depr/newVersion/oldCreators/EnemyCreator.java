package depr.newVersion.oldCreators;
...
public class EnemyCreator {
  ...
  private static final String[] SIZE = new String[]{"tiny", "small", "short", "thin", "fat", "tall",
      "large",
  ...
  private static final double[] STRENGTH_VALS = new double[]{0.42, 0.67, 0.75, 0.86, 1.20, 1.35,
      1.89};

  private static final String[] NAMES = new String[]{"fairy", "spider", "gnome", "elf", "ghoul",
      "dwarf",
      "mummy", "zombie", "goblin", "ogre", "skeleton", "troll", "living tree", "griffin", "golem",
      "knight",
  ...
  private static final String[] PREFIX_NAMES = new String[]{"almost dead", "wounded", "very weak",
      "weak", "small",
      "regular", "angry", "strong", "large", "very strong", "huge", "giant", "evil", "nightmare",
      "devilish"};
  ...
  private static final String[] ENEMY_NAMES = new String[]{"fairy", "spider", "gnome", "elf",
      "ghoul", "dwarf",
      "mummy", "zombie", "goblin", "ogre", "skeleton", "troll", "living tree", "griffin", "golem",
      "knight",
      "unicorn", "centaur", "minotaur", "vampire", "werewolf", "phoenix", "demon"};
  ...
  private static final String[] SUFFIX_NAMES = new String[]{"with only one arm",
      "that seems scared",
      "that looks dangerous", "that has a strong aura of power", "king"};
  private static final double[] SUFFIX_VALUES = new double[]{0.33, 0.67,
      1.22, 1.74, 2.16};

  private static final String[] BOSS_NAMES = new String[]{"Smaug", "Drogon", "Igneel", "Porunga",
      "Shenlong",
  ...
  public static Enemy createEnemy(int mapID, int levelOfPlayer) {
    ...
    String name;
    if (multiplier
        < 2) {     // Enemies get weak weapons if we are on the first map and the player is level 1.
  ...
  public static Enemy createRandomEnemy(int mapID) {
    if (ThreadLocalRandom.current().nextBoolean()) {
      ...
      String name =
          PREFIX_NAMES[decider1] + " " + ENEMY_NAMES[decider2] + " " + SUFFIX_NAMES[decider3];
      int health =
          (int) (BASE_HEALTH[decider2] * PREFIX_VALUES[decider1] * SUFFIX_VALUES[decider3]) * mapID;
  ...
  public static Enemy createBossEnemy(Difficulty difficulty, int levelOfPlayer, int mapID) {
    ...
    return new Enemy(BOSS_NAMES[randomIntInRange(0, BOSS_NAMES.length - 1)], bossHealth, bossWeapon,
        true);
  }
