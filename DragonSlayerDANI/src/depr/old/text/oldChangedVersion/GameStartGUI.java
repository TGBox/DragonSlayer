...
public class GameStartGUI extends JFrame implements ActionListener {
  ...
  /**
   * main method to get everything going. the default look and feel of the GUI is altered to the
   * systems design. afterwards, it gets the user name via a JOptionPane and starts the gui within
