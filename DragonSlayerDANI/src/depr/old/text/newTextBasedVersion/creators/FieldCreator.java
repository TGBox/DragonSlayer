...
public class FieldCreator {
  ...
  /**
   * method to create an adapted field that changes the occurring enemies and weapons according to
   * the player's level.
   *
  ...
  public static Field createAdaptedField(int mapID, int levelOfPlayer) {
    ...
    return createCustomField(FIELD_NAMES[randomIntInRange(0, FIELD_NAMES.length - 1)], enemy, item,
        mapID);
  }
