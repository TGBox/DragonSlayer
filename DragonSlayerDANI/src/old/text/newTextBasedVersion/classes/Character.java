...
public class Character {
    ...
    public void displayBag(){
        if(this.getBagCounter() == 0){
            ...
            if(this.getBagCounter() == 1){
                System.out.println("Your bag contains 1 item. " + (bag.length - bagCounter) + " free slots left.\n");
    ...
    public void levelUp(Enemy enemy, Difficulty difficulty) {
        ...
        if(this.getExperience() >= 25 && this.getExperience() < 50 && this.getLevel() != 2){
            ...
            System.out.println("Congratulations! " + this.getName() + " has reached level " + this.getLevel() + "!");
            System.out.println("Your stats have improved. Maximum health now at " + this.getStartingHealth() + ".");
        }
