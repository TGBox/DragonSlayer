package old.text.newTextBasedVersion.creators;
...
public class WeaponCreator {
    ...
    private static final String[] SUFFIX_STRINGS = new String[]{"useless", "broken", "deformed", "lightweight",
    ...
    private static final String[] WEAPON_NAMES = new String[]{"spoon", "stick", "fork", "stone", "knife", "hammer",
            "dagger", "tomahawk", "rapier", "club", "spear", "axe", "katana", "morning star", "sword", "longsword",
    ...
    private static final double[] ACCURACIES = new double[]{0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65};
    ...
    /**
     * method to create a weapon that is restricted in the randomness of the index selections for the attributes.
     * int values represent the maximum index for the arrays that hold the attributes.
     ...
     * @return
     */
    public static Item createRestrictedWeapon(int maxIndexSuffix, int maxIndexName, int maxIndexAccuracy){
